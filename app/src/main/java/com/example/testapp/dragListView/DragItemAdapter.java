...
public abstract class DragItemAdapter<T, VH extends DragItemAdapter.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected List<TourismSpotModel> mItemList;
    ...
    public void setItemList(List<TourismSpotModel> itemList) {
        mItemList = itemList;
        notifyDataSetChanged();
    }

    public List<TourismSpotModel> getItemList() {
        return mItemList;
    }
    ...
    public void addItem(int pos, TourismSpotModel item) {
    ...
    public void changeItemPosition(int fromPos, int toPos) {
        if (mItemList != null && mItemList.size() > fromPos && mItemList.size() > toPos) {
            TourismSpotModel item = mItemList.remove(fromPos);
