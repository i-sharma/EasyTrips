...
package com.example.testapp.dragListView;
...
public class BoardView extends HorizontalScrollView implements AutoScroller.AutoScrollListener {
    ...
    private void init(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.example.testapp.R.styleable.BoardView);

        mColumnSpacing = a.getDimensionPixelSize(com.example.testapp.R.styleable.BoardView_columnSpacing, 0);
        mBoardEdge = a.getDimensionPixelSize(com.example.testapp.R.styleable.BoardView_boardEdges, 0);
    ...
    private DragItemRecyclerView addColumnTo(int index, @NonNull ColumnProperties columnProperties) {
        ...
        final DragItemRecyclerView recyclerView = (DragItemRecyclerView) LayoutInflater.from(getContext()).inflate(com.example.testapp.R.layout.drag_item_recycler_view, this, false);
